...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        int width = DensityUtils.dp2px(getContext(), 225);
        int height = DensityUtils.dp2px(getContext(), 225);
        int leftOffset = (screenWidth - width) / 2;
        int topOffset = (screenHeight - height) / 2;
        int left = leftOffset + RECT_OFFSET_X;
        int top = topOffset + RECT_OFFSET_Y;
        int right = leftOffset + width + RECT_OFFSET_X;
        int bottom = topOffset + height + RECT_OFFSET_Y;
...
//            return;
        ...
        canvas.drawRect(0, 0, outWidth, frame.top, paint);
        canvas.drawRect(0, frame.top, frame.left, frame.bottom + 1, paint);
        canvas.drawRect(frame.right + 1, frame.top, outWidth, frame.bottom + 1, paint);
        canvas.drawRect(0, frame.bottom + 1, outWidth, outHeight, paint);
